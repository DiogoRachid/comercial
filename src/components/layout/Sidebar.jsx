...
import {
  ...
  ChevronLeft, ChevronRight, Bot, Radio, ClipboardList, Link2, Landmark
} from 'lucide-react';
...
const menuItems = [
  ...
  { icon: Radio, label: 'Canais de Venda', path: '/canais' },
  { icon: ClipboardList, label: 'Pedidos', path: '/pedidos' },
  { icon: ShoppingCart, label: 'Vendas', path: '/vendas' },
  { icon: FileText, label: 'Fiscal (NF-e)', path: '/fiscal' },
  { icon: Receipt, label: 'Notas Fiscais', path: '/notas-fiscais' },
  { icon: Users, label: 'Clientes', path: '/clientes' },
  { icon: Store, label: 'Marketplaces', path: '/marketplaces' },
  { icon: Link2, label: 'Bling ERP', path: '/bling' },
